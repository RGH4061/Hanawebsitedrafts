...
function HomepageV1bCircuit({ rightPanel = 'stats', middle = 'card' }) {
  ...
  const navMenus = {
    About: {
      ...
      { h: 'Responsibility', items: ['Sustainability', 'ESG reports', 'Community'] },
      { h: 'Connect', items: ['News & media', 'Careers', 'Contact us'] }] },
    ...
    Capabilities: {
      ...
      { h: 'Automation', items: ['In-line AOI & SPI', 'Robotic Handling & Test', 'MES-Driven Traceability'] },
    ...
    'Investor Relations': {
      ...
      links: ['Investor News', 'Group Structure & Shareholders', 'Annual Report', 'Sustainability', 'Governance Documents', 'Investor Events & Contacts', 'Investor FAQ'] } };
  ...
  return (
    <div style={{ background: 'var(--bg)', color: 'var(--ink)', fontFamily: 'var(--font-text)' }}>
      ...
      <header style={{ background: '#fff', fontFamily: 'var(--font-text)' }}>
        ...
        onMouseLeave={closeNav}>
          ...
          <div style={{ ...sectionWrap, padding: '18px 32px', display: 'flex', alignItems: 'center', gap: 32 }}>
            <img src={(window.__resources&&window.__resources.logoFull)||"assets/hana-logo-full-trimmed.png"} alt="Hana" style={{ width: 200, height: 65, objectFit: 'contain', objectPosition: 'left center', display: 'block' }} />
          ...
          style={{ position: 'absolute', top: '100%', left: 0, right: 0, zIndex: 60,
            ...
            boxShadow: '0 24px 48px rgba(3,10,23,.12)' }}>
              ...
              <div style={{ borderRight: '1px solid var(--line)', paddingRight: 40 }}>
                  ...
                  <a href="#" className="hana-link" style={{ fontSize: 11, fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: 6, letterSpacing: '.1em', textTransform: 'uppercase' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', columnGap: 28, rowGap: 2 }}>
                  ...
                  <a key={it.name} href="#" className="v1bc-mega-card" style={{ display: 'block', padding: '10px 12px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: `repeat(${navMenus[openMenu].groups.length}, 1fr)`, gap: 24 }}>
                    ...
                    <div key={g.h}>
                          <a href="#" className="v1bc-mega-gh" style={{ display: 'inline-block', fontSize: 13, fontWeight: 700, lineHeight: 1.3, marginBottom: 12, textWrap: 'balance' }}>{g.h}</a>
                          <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: 10 }}>
                            {g.items.map((i) =>
                        <li key={i}>
                                <a href="#" className="v1bc-mega-tlink" style={{ fontSize: 12.5, color: 'var(--ink-2)', textDecoration: 'none', lineHeight: 1.35, display: 'block' }}>{i}</a>
                              </li>
                        )}
                          </ul>
                        </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: `repeat(${navMenus[openMenu].cols.length}, 1fr)`, gap: 36 }}>
                  ...
                  <div key={col.h}>
                          ...
                          <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: 10 }}>
                            {col.items.map((i) =>
                      <li key={i}><a href="#" className="v1bc-mega-tlink" style={{ fontSize: 13, color: 'var(--ink-2)', textDecoration: 'none' }}>{i}</a></li>
                      )}
                          </ul>
                        </div>
                  )}
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', columnGap: 40, rowGap: 26 }}>
                  ...
                  <div key={country}>
                          ...
                          <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column' }}>
                            {cities.map((l) =>
                      <li key={l.city}>
                                <a href="#" className="v1bc-mega-card" style={{ display: 'flex', alignItems: 'baseline', gap: 8, padding: '7px 8px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', columnGap: 40, rowGap: 2 }}>
                  ...
                  <a key={i} href="#" className="v1bc-mega-card" style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '10px 10px' }}>
      ...
      <section style={{ position: 'relative', background: '#030a17', overflow: 'hidden', cursor: 'crosshair', height: "550px" }}>
        ...
        <div style={{ position: 'absolute', zIndex: 15, top: '50%', left: 52,
          ...
          <div style={{ display: 'flex', gap: 12, pointerEvents: 'auto' }}>
            ...
            <a href="#" className="hana-btn" style={{ background: 'transparent', color: 'rgba(255,255,255,.72)', border: '1px solid rgba(255,255,255,.22)', borderRadius: 4 }}>
              Our capabilities
            </a>
          </div>
        </div>
        ...
        <aside style={{ position: 'absolute', zIndex: 15, top: '50%', right: 40,
          ...
          width: 580, pointerEvents: 'auto' }}>
            ...
            borderRadius: 10, overflow: 'hidden' }}>
              ...
              {/* Thumbnail image */}
              <img src={(window.__resources&&window.__resources.videoThumb)||"assets/video-placeholder-factory.jpg"} alt=""
      ...
      <section style={{ background: 'var(--hana-blue-deep)', color: '#fff', position: 'relative', overflow: 'hidden' }}>
          ...
          <img src={(window.__resources&&window.__resources.markWhite)||"assets/hana-mark-white.svg"} alt="" style={{ position: 'absolute', right: -80, bottom: -80, width: 440, opacity: 0.05, pointerEvents: 'none' }} />
        </section> :
      middle === 'light' ? (
...
We hold that work to the most stringent quality standards — ISO 9001, IATF 16949, ISO 13485, ISO 14001, ISO 45001, and ISO 27001 — earning recognition from some of the world's most demanding customers.</p>
                <a href="#" className="hana-btn hana-btn-primary">Why Hana {li('arrow-right', 14, '#fff')}</a>
              </div>
              <div style={{ position: 'relative', aspectRatio: '4/5', overflow: 'hidden', borderRadius: 8, border: '1px solid var(--line)' }}>
                <img src={(window.__resources&&window.__resources.cleanroomSmt)||"uploads/cleanroom-smt-line.png"} alt="SMT line operator at the inspection console — Hana cleanroom"
      ...
      <section style={{ background: 'var(--bg)' }}>
        <div style={{ ...sectionWrap, padding: '32px' }}>
          <div style={{ background: 'var(--hana-blue-deep)', color: '#fff', borderRadius: 14, padding: '64px 48px', position: 'relative', overflow: 'hidden' }}>
            ...
            <img src={(window.__resources&&window.__resources.markWhite)||"assets/hana-mark-white.svg"} alt="" style={{ position: 'absolute', right: -60, bottom: -60, width: 320, opacity: 0.06 }} />
          </div>
        </div>
      </section>
      }
      ...
      {(() => {
          ...
          const imgFor = {
            'Automotive': { src: __r.marketAuto||'uploads/automotive.jpeg', pos: '60% 45%' },
            'Industrial & IoT': { src: __r.marketIndustrial||'uploads/parej-richard-pxs2yJ6Lb9k-unsplash.jpg', pos: 'center' },
            'Telecommunications': { src: __r.marketTelecom||'uploads/telecommunications.jpeg', pos: '64% 42%' },
            'RFID': { src: __r.marketRfid||'uploads/rfid-tire.jpeg', pos: '46% 46%' },
            'Medical': { src: __r.marketMedical||'uploads/medical.jpeg', pos: '46% 34%' }
          };
          ...
          const Tile = ({ name, size = 'sq', corner, area }) => {
            ...
            return (
              <a href="#" className="v1bc-ma-card" style={{
        ...
        <div style={{ ...sectionWrap, padding: '96px 32px', display: 'grid',
          ...
          <div>
            <div style={{ marginBottom: 28, borderRadius: 8, overflow: 'hidden', aspectRatio: '16/9' }}>
              <img
                src={(window.__resources&&window.__resources.hqBuilding)||"assets/hana-bkk.jpg"}
            ...
            <a href="#" className="hana-link" style={{ fontSize: 12, fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: 6, letterSpacing: '.1em', textTransform: 'uppercase' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1,
            ...
            {locs.map((l, i) =>
            <a key={l.city} href="#" className="v1bc-loc-card"
        ...
        <div style={{ ...sectionWrap, padding: '96px 32px', position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1.2fr) minmax(0,1fr)', gap: 48, alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: 12 }}>
              <a href="#" className="hana-btn hana-btn-primary">Talk to engineering {li('arrow-right', 14, '#fff')}</a>
              <a href="#" className="hana-btn hana-btn-secondary" style={{ color: '#fff', borderColor: 'rgba(255,255,255,0.4)' }}>Request a quote</a>
            </div>
          </div>
        </div>
      </section>
